...
Just because data involves numbers *does not* mean it is numerical data. Take, for example, a phone number. Adding two phone numbers doesn't necessarily produce something that is a phone number. What would the "average" phone number even mean and why would you want to know it? Phone numbers are categorical data.a
