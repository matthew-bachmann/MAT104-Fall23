...
#### **Example:** 
Let's perform a hypothesis test to determine if the data from the last example provides sufficient evidence to think the there is a real difference in the population proportions. 
